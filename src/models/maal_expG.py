...
class MultiTaskNetwork(nn.Module):
    ...
    def forward(self, x):
        ...
        # -------------------------------------------------------------------
        # EXPERIMENT G: FEATURE MASKING (ATTENTION-GUIDED CLASSIFICATION)
        # -------------------------------------------------------------------
        ...
        # Mask the final features using absolute blocking.
        # Background gets *0 (deleted), Crack gets *1 (kept).
        f_masked = f_final * attention_mask_resized
...
class MultiTaskLoss(nn.Module):
    # MAAL Exp G: Exact same clean loss as Exp F
